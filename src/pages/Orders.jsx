                ...
                <div className='mb-30 grid grid-cols-1  gap-5 w-full '>
                    {orders.length > 0 ? (
                        orderItems.map((item,index) => {
                            return (
                                    <div key={index} className='w-full min-h-[25vh] pt-4 flex  bg-[#d6d1d1]/50 items-start  2xl:justify-between 2xl:items-center 2xl:static relative '>
                                        <div className='2xl:flex flex'>
                                            ...
                                            <div className='ml-5'>
                                                ...
                                                <h1 className='text-2xl py-1'>₹{item[0].totalPrice}.00</h1>
                                            </div>
