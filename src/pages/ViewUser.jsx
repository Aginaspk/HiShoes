...
function ViewUser({id,closeUser}) {
    ...
    return (<>
        ...
        <div className='  fixed top-[10%] left-[50%] blur-none z-50'>
                <div className="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4 ">
                    ...
                    <div className="py-4 px-6">
                        ...
                        <div className="flex items-center mt-4 text-gray-700">
                            ...
                            <h1 className="px-2 text-sm">Role : {user.role}</h1>
                        </div>
                        <div className="flex items-center mt-4 text-gray-700">
                            <svg className="h-6 w-6 fill-current" viewBox="0 0 512 512">
                        ...
                        <div className="flex items-center mt-4 text-gray-700">
                            <button className='w-[336px] h-[50px] bg-gray-800 text-white' onClick={closeUser}>Close</button>
                        </div>
                    </div>
                </div>
